...
+ Walk-through equations for dynamics and likelihoods from [document](LINK ME.PDF) 
...
```
.pull-center[$\sigma_G$ now at individual strata]
...
---
# Survey Biomass
$B_y^f={\epsilon_y^fq}^f\sum_{i}\sum_{a}{{ \psi_{if} w_a^{k,f} s_a^f N_{y,a}^i}$
...
<Br><Br><Br><Br><Br><Br>
# .inverse[Take a break?]
## .inverse[Up next: Reference points, and things I haven't thought through yet]
...
---
# Things I haven't thought through yet (in detail)
+ .inverse[Forecasting]
+ .inverse[Aging Error]
